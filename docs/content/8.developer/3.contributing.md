...
- **Existing JavaScript**: You may maintain existing JavaScript files, but new functionality should be TypeScript
...
- **Run Before PR**: Execute `pnpm run test` and ensure all tests pass
